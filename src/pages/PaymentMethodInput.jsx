...
const PaymentMethodInput = ({ onNext, onPrev, paymentData, setPaymentData }) => {
    ...
    const handleFileUpload = (e) => {
        ...
        if (file) {
            ...
            // Di sini lo bisa nyimpen file-nya ke state global atau dibikin URL sementara
    ...
    return (
        <div className="max-w-md mx-auto bg-white p-6 sm:p-8 border border-slate-100 shadow-sm rounded-3xl">
            ...
            <div className="flex gap-3 mt-8">
                ...
                <button
                    onClick={onNext}
                    className="flex-1 py-3 text-sm font-semibold text-white bg-gradient-to-r from-blue-500 to-pink-500 rounded-xl shadow-md opacity-90 hover:opacity-100 transition-all"
                >
                    Lanjut Ringkasan
                </button>
            </div>
